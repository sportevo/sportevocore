...
//-----------------------------
	...
	function addAttributeToProduct($get) {
		...
		$this->getAndPrepare('options_quantity', $get, $options_quantity);  // JFJ - artikelnr per attribut
		...
		$data = array(
			...
			'options_quantity' => $options_quantity,  // JFJ - artikelnr per attribut
			'price_prefix' => $prefix
		);
...
// End QT Pro Plugin
	...
	//	amDB::perform(TABLE_PRODUCTS_ATTRIBUTES,$data, 'update',"products_id='$this->intPID' and options_id='$optionId' and options_values_id='$optionValueId' and options_quantity='$options_quantity'");  // JFJ
...
//-----------------------------
			...
			//print_R($res);
				...
				$this->arrAllProductOptionsAndValues[$optionsId]['values'][$res['options_values_id']]['options_quantity'] = $res['options_quantity'];
