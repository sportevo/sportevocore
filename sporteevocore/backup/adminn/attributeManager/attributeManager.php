...
<?php echo tep_draw_input_field("options_quantity_$optionId",'','style="margin:3px 0px 3px 0px;" id="options_quantity_'.$optionId.'"')?>
<!-- JFJ -->		
...
<!--  JFJ - artikelnr per attribut BOF -->
					 <?php echo tep_draw_input_field("options_quantity_$optionValueId",$optionValueInfo['options_quantity'],' style="margin:3px 0px 3px 0px;" id="options_quantity_'.$optionValueId.'" size="12" onfocus="amF(this)" onblur="amB(this)" onChange="return amUpdate(\''.$optionId.'\',\''.$optionValueId.'\',\'options_quantity\');"'); ?>
...
<!--  JFJ - artikelnr per attribut BOF -->
			<td valign="top" class="newOptionPanel-label">
				Art nr: <?php echo tep_draw_input_field('options_quantity_new','','size="12" id="options_quantity_new"'); ?>
			</td>
<!--  JFJ - artikelnr per attribut EOF -->
			<?php
			if(AM_USE_SORT_ORDER) {
