...
//
//  $Id: pdf_fpdf.php,v 1.54 2005/10/12 ep Exp $
...
// ignore_user_abort line3/4
// Fix in line 1484
/*******************************************************************************
* FPDF Enhanced, Version 1.53 Patched with better landscape Support            *
* April 2004, by Antonios THROUVALAS [antonios(at)throuvalas(dot)net]          *
* August 2004,by Nicolas Hilly (n.hilly@laposte.net)                           *
*                                                                              *
* Based on FPDF (http://www.fpdf.org), Version 1.52, by Olivier PLATHEY        *
* Credit goes to:                                                              *
...
*                                                                              *
*******************************************************************************/
function FPDF($orientation=PDF_ORIENTATION,$unit='mm',$format='A4')
{
	//Some checks
	$this->_dochecks();
	...
	elseif($orientation=='l' or $orientation=='landscape')
	{
        ...
        // NH moved from before Page orientation, fw use wpt instead of fwpt
	$this->fw=$this->wPt/$this->k;
	$this->fh=$this->hPt/$this->k;
...
function Image($file,$x,$y,$w=0,$h=0,$type='',$link='')
{
	...
	if(!isset($this->images[$file]))
	{
		...
		elseif($type=='gif') 						 // Added for GIF Support 
...
// Added for GIF Support
function _parsegif($file) 
{ 
	//Function by Jerome Fenal (jerome.fenal@logicacmg.com)
	require_once 'pdf_gif.php'; //GIF class in pure PHP from Yamasoft (http://www.yamasoft.com/php-gif.zip)
