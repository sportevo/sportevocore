<?php
/*
  $Id: helpdesk_search.php,v 1.0 2002/06/10
...
<p>
<form method="post" action="helpdesk_search.php">
<input type="hidden" name="submit" value="true">
<input type="hidden" name="usern" value="<?php echo $usern; ?>">
<input type="hidden" name="passw" value="<?php echo $passw; ?>">
<B><?php echo TEXT_SEARCH;?></B>: <select name="type">
<option value='ticket_id'><?php echo TEXT_TICKET2;?>
<option value='problem'><?php echo TEXT_PROBLEM;?>
<option value='solution'><?php echo TEXT_SOLUTION;?>
<option value='name'><?php echo TEXT_NAME;?>
</select><BR>
<b><?php echo TEXT_SEARCH_TERMS;?></b>: <input type="text" name="term" value=""><br>
<BR><BR>
...
<input type="hidden" name="passw" value="<?php echo $passw; ?>">
<B><?php echo TEXT_SEARCH;?></B>: <select name="type">
<option value='ticket_id'><?php echo TEXT_TICKET;?>
<option value='problem'><?php echo TEXT_PROBLEM;?>
<option value='solution'><?php echo TEXT_SOLUTION;?>
<option value='name'><?php echo TEXT_NAME;?>
</select><BR>
...
<br><BR>
<?php
$query = "SELECT * FROM helpdesk WHERE $type LIKE '%$term%'";
$result = tep_db_query($query);
?>
<table align=center border="0" bgcolor="ffffff" width="90%">
<tr>
<td><font face="Verdana, Verdana, arial, sans-serif, sans-serif" size=2 color="000000"><b><?php echo TEXT_RESULTS;?></b></font></td>
