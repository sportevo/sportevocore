<?php
/*
  $Id: catalog/admin/customers_groups.php v1.3 2008/08/01
      ...
      <tr>
	    ...
	    <td><table border="0" width="100%" cellspacing="0" cellpadding="0">
          <tr>
	       ...
	       <td class="dataTableHeadingContent"><a href="<?php echo $_SERVER['PHP_SELF'] . '?listing=group'; ?>"><?php echo tep_image(DIR_WS_IMAGES . 'icon_up.gif', ' Sort ' . TABLE_HEADING_NAME . ' --> A-B-C From Top '); ?></a>&nbsp;<a href="<?php echo $_SERVER['PHP_SELF'] . '?listing=group-desc'; ?>"><?php echo tep_image(DIR_WS_IMAGES . 'icon_down.gif', ' Sort ' . TABLE_HEADING_NAME . ' --> Z-X-Y From Top '); ?></a><br><?php echo TABLE_HEADING_NAME; ?></td>
