<?php
/*
  $Id: helpdesk_deluser.php,v 1.0 2002/06/10
...
<p>
<form method="post" action="helpdesk_deluser.php">
<input type="hidden" name="submit" value="true">
<input type="hidden" name="usern" value="<?php echo $usern; ?>">
<input type="hidden" name="passw" value="<?php echo $passw; ?>">
<?php echo TEXT_USERNAME;?><select name="memberdel">
<?php
$query = "SELECT * FROM helpdesk_members;";
$result = tep_db_query($query);
while(list($username, $password, $email, $signature) = mysql_fetch_row($result))
{
...
if($memberdel != 'admin') {
$query = "DELETE FROM helpdesk_members WHERE username = '$memberdel';";
$result = tep_db_query($query);
}
?>
<tr><td bgcolor="#ffffff">
...
if($memberdel == 'admin') {
?>
<br><p><?php echo TEXT_ACCOUNT;?><B><?php echo $memberdel; ?></b><?php echo TEXT_ACCOUNT2;?></p>
<?php } else { ?>
<br><p><?php echo TEXT_ACCOUNT;?><B><?php echo $memberdel; ?></b><?php echo TEXT_ACCOUNT3;?></p>
<?php } ?>
</p>
</font>
<P>
