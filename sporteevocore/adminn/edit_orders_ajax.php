...
ONTC Ecom - Developers Version
  ...
  */
  ...
  if ($action == 'update_product_value_field') {
	  tep_db_query("UPDATE " . TABLE_ORDERS_PRODUCTS . " SET products_price = '" . tep_db_input(tep_db_prepare_input($_GET['price'])) . "', products_cost = '" . tep_db_input(tep_db_prepare_input($_GET['cost'])) . "', final_price = '" . tep_db_input(tep_db_prepare_input($_GET['final_price'])) . "' WHERE orders_products_id = '" . $_GET['pid'] . "' AND orders_id = '" . $_GET['oID'] . "'");
	  
//3.5 Update costs Francesco Rossi


	  tep_db_query("UPDATE " . TABLE_ORDERS_PRODUCTS . " SET  products_cost = '" . tep_db_input(tep_db_prepare_input($_GET['cost'])) . "' WHERE orders_products_id = '" . $_GET['pid'] . "' AND orders_id = '" . $_GET['oID'] . "'");
