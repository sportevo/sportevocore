<?php
/*
  $Id: helpdesk_edituser.php,v 1.0 2002/06/10
...
<form method="post" action="helpdesk_edituser.php">
<input type="hidden" name="submit" value="true">
<input type="hidden" name="usern" value="<?php echo $usern; ?>">
<input type="hidden" name="passw" value="<?php echo $passw; ?>">
<b><?php echo TEXT_USERNAME;?></b>: <input type="text" name="passwo" value="<?php echo $password; ?>"><br>
<b><?php echo TEXT_EMAIL;?></b>: <input type="text" name="emailad" value="<?php echo $email; ?>"><br>
<b><?php echo TEXT_SIGNATURE;?></B>:<br>
<textarea rows="5" name="sig" cols="45"><?php echo $signature; ?></textarea><br>
<BR>
...
$query = "UPDATE helpdesk_members SET password = '$passwo', email = '$emailad', signature = '$sig' WHERE username = '$usern';";
$result = tep_db_query($query) or die ("Error in query: $query. " . mysql_error());
?>
<tr><td bgcolor="#ffffff">
<br><blockquote>
<font face="verdana, arial, sans-serif" size=2>
<br><p><?php echo TEXT_ACCOUNT;?><B><?php echo $usern; ?></b><?php echo TEXT_ACCOUNT2;?></p>
</p>
</font>
<P>
<center><form method=post action="helpdesk.php"><input type="hidden" name="usern" value="<?php echo $usern; ?>"><input type="hidden" name="passw" value="<?php echo $passw; ?>"><input type="submit" value="<?php echo TEXT_RETURN;?>"></form></center>
