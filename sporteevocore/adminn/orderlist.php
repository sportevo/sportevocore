...
if ($start=="" && $end=="") {
 $orders = tep_db_query("SELECT orders_id, orders_status, date_purchased, customers_name, cc_owner, customers_company, customers_email_address, billing_street_address, billing_city, billing_state, billing_postcode, billing_country, customers_telephone, delivery_name, delivery_company, delivery_street_address, delivery_city, delivery_state, delivery_postcode, delivery_country, cc_type, cc_number, cc_expires 
...
$orders_products = tep_db_query("select products_model, products_price, products_quantity, products_name, orders_products_id, products_id from orders_products
where orders_id = " . $Orders_id);
...
//	$csv_output_item .= "," . "BEGIN_ITEM". "," ;
	...
	$csv_output_item .= filter_text($row_orders_products["products_id"]) . ",";
