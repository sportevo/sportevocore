...
// >>> BEGIN REGISTER_GLOBALS
    // These variables are accessed directly rather than through $_GET or $_GET later in this script
...
?>
          <tr>
 <td colspan="8"><?php echo tep_black_line(); ?></td><!-- EOF SPPC hide attributes from groups mod -->          </tr>
        </table></form></td>
      </tr>
    </table></td>
