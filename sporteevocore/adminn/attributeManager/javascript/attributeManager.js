...
function amUpdate(optionId, optionValueId, optionSender) {
	...
	options_quantity=getDropDownValue('options_quantity_'+optionValueId);
	...
	setDropDownValue('options_quantity_'+optionValueId,options_quantity,'i');

	if((price!='0.0000')&&((prefix=='')||(prefix==' '))){
		setDropDownValue('prefix_'+optionValueId,'%2B','s');//+
	}

	amSendRequest('amAction=update&option_id='+optionId+'&option_value_id='+optionValueId+'&price='+getDropDownValue('price_'+optionValueId)+'&options_quantity='+getDropDownValue('options_quantity_'+optionValueId)+'&prefix='+getDropDownValue('prefix_'+optionValueId)+'&sortOrder='+getDropDownValue('sortOrder_'+optionValueId),'',false);
//	amSendRequest('amAction=update&option_id='+optionId+'&option_value_id='+optionValueId+'&price='+getDropDownValue('price_'+optionValueId)+'&options_quantity='+getDropDownValue('options_quantity_'+optionValueId)+'&prefix='+getDropDownValue('prefix_'+optionValueId),'',false);   // JFJ - this one works, but has no sortOrder
	getElement('price_'+optionValueId).blur();
	var el = getElement('sortOrder_'+optionValueId);
	var el = getElement('options_quantity_'+optionValueId);
	if(el != null) el.blur();
	return false;
}
...
//	var sortOrder = getDropDownValue('newSort');
	var sortOrder = -1;
	var options_quantity = getDropDownValue('options_quantity_new');   // JFJ - artikelnr per attribut
	
	if(0 == option || 0 == optionValue)
		return false;
//	amSendRequest('amAction=addAttributeToProduct&option_id='+option+'&option_value_id='+optionValue+'&prefix='+pricePrefix+'&price='+price+'&sortOrder='+sortOrder+'&options_quantity='+options_quantity);
	amSendRequest('amAction=addAttributeToProduct&option_id='+option+'&option_value_id='+optionValue+'&prefix='+pricePrefix+'&options_quantity='+options_quantity+'&sortOrder='+sortOrder+'&price='+price);
	return false;
}
...
function amAddOptionValueToProduct(optionId) {
	...
	var options_quantity = getDropDownValue('options_quantity_'+optionId);
	if(0 == optionValueId)
		return false;
//	amSendRequest('amAction=addOptionValueToProduct&option_id='+optionId+'&option_value_id='+optionValueId,'',true,'currentAttributes');
	amSendRequest('amAction=addOptionValueToProduct&option_id='+optionId+'&options_quantity='+options_quantity+'&option_value_id='+optionValueId,'',true,'currentAttributes');
	return false;
}
