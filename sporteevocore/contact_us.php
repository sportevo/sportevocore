      ...
      <tr>
        <td><table border="0" width="100%" cellspacing="0" cellpadding="0">
          <tr>
            ...
            <td class="pageHeading" align="left"><?php echo tep_image(DIR_WS_IMAGES . 'table_background_contact_us.gif', HEADING_TITLE, HEADING_IMAGE_WIDTH, HEADING_IMAGE_HEIGHT); ?>
         </td>
          </tr>
        ...
        <td><table border="0" width="100%" cellspacing="1" cellpadding="2" class="infoBox">
          <tr class="infoBoxContents">
            <td><table border="0" width="100%" cellspacing="0" cellpadding="2">
              ...
              <tr class="infoBoxContents"> <td colspan="3" width="100%" ><p class="pageHeading">Assistenza Live con Skype:</p><table align="center"  width="95%"><tr><td > <a href="skype:yakans?call"><img src="http://download.skype.com/share/skypebuttons/buttons/call_blue_white_124x52.png" style="border: none;" width="124" height="52" alt="Skype Me�!" /></a>
<br /></p></td></tr></table>
</td> </tr>
            </table></td>
          </tr>
