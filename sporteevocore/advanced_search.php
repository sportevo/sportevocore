    ...
    <td width="100%" valign="top"><?php echo tep_draw_form('advanced_search', tep_href_link(FILENAME_ADVANCED_SEARCH_RESULT, '', 'NONSSL', false), 'get', 'onSubmit="return check_form(this);"') . tep_hide_session_id(); ?><table border="0" width="100%" cellspacing="0" cellpadding="0">
      <tr>
        <td><table border="0" width="100%" cellspacing="0" cellpadding="0">
          <tr>
            <td align="right" class="pageHeading"><?php echo HEADING_TITLE_1; ?></td>
...
<?php
 ...
 <?php $info_box_contents[] = array('text' => tep_draw_input_field('keywords', '', '')); ?>
	<div id="btncmp4"><?php  $info_box_contents[] = array('align' => 'left', 'text' => tep_draw_checkbox_field('search_in_description', '1') . ' ' . TEXT_SEARCH_IN_DESCRIPTION . (CATEGORY_LIST_IN_SEARCH ? tep_draw_checkbox_field('scat_only', '1', false) . ' ' . TEXT_SEARCH_CATEGORIES_ONLY : ''));  

 new infoBox($info_box_contents);
?><button type="submit" class="cssButtonhome"><img src="http://www.sportevo.pro/images/search.png"></button></div></div>
