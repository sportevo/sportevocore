...
<!-- body_text //-->
    <span class="mainform"><?php echo tep_draw_form('create_account', tep_href_link(FILENAME_CREATE_ACCOUNT, '', 'SSL'), 'post', 'onSubmit="return check_form(create_account);"') . tep_draw_hidden_field('action', 'process'); ?><table border="0" width="100%" cellspacing="0" cellpadding="0"></span>
     <span class="pageHeading"><?php echo HEADING_TITLE; ?></span>
            <span class="pageHeading"><?php echo tep_image(DIR_WS_IMAGES . 'table_background_account.gif', HEADING_TITLE, HEADING_IMAGE_WIDTH, HEADING_IMAGE_HEIGHT); ?></span>
...
?>
          ...
          <div class="accountBoxContents">
           ...
           <div class="h2"><b><br><?php echo CATEGORY_PERSONAL; ?></b><br></span>
...
?>
              <div class="accountBoxContents">
                 <div class="maincapture"><?php echo ENTRY_FIRST_NAME; ?>  <div class="maincapture"><?php echo ENTRY_LAST_NAME; ?></div>
             <div class="accountBoxContents">  <?php  echo tep_draw_input_field('firstname', $fbme['first_name']) . '&nbsp;' . (tep_not_null(ENTRY_FIRST_NAME_TEXT) ? '<span class="inputRequirement">' . ENTRY_FIRST_NAME_TEXT . '</span>': ''); ?></div> 
              		 <div class="maincapture"><?php echo tep_draw_input_field('lastname', $fbme['last_name']) . '&nbsp;' . (tep_not_null(ENTRY_LAST_NAME_TEXT) ? '<span class="inputRequirement">' . ENTRY_LAST_NAME_TEXT . '</span>': ''); ?></div>
...
?>
              <div class="accountBoxContents">
                 <div class="maincapture"><?php echo ENTRY_DATE_OF_BIRTH; ?></div> 			  <!--PIVACF start-->
<?php  if (ACCOUNT_CF == 'true') {?>                                                
                     
                 <div class="maincapture"><?php echo ENTRY_CF; ?></div>
               <div class="maincapture"><?php echo tep_draw_input_field('dob', $fbme['birthday']) . '&nbsp;' . (tep_not_null(ENTRY_DATE_OF_BIRTH_TEXT) ? '<span class="inputRequirement">' . ENTRY_DATE_OF_BIRTH_TEXT . '</span>': ''); ?></div>
...
?>
       ...
       <div class="h2"><b><?php echo CATEGORY_CONTACT; ?></b></div>
     
        <div class="accountBox">
          <div class="accountBoxContents">
            
                 <div class="maincapture"><?php echo ENTRY_TELEPHONE_NUMBER; ?></td> <div class="maincapture"> <?php echo ENTRY_EMAIL_ADDRESS; ?></div>
                 <div class="maincapture"><?php echo tep_draw_input_field('telephone') . '&nbsp;' . (tep_not_null(ENTRY_TELEPHONE_NUMBER_TEXT) ? '<span class="inputRequirement">' . ENTRY_TELEPHONE_NUMBER_TEXT . '</span>': ''); ?></td> <div class="maincapture"><?php echo tep_draw_input_field('email_address', $fbme['email']) . '&nbsp;' . (tep_not_null(ENTRY_EMAIL_ADDRESS_TEXT) ? '<span class="inputRequirement">' . ENTRY_EMAIL_ADDRESS_TEXT . '</span>': ''); ?></div>
...
?>
       ...
       <div class="h2"><b><?php echo CATEGORY_PASSWORD; ?></b><br></div>
    <div class="accountBox">
          <div class="accountBoxContents">
            
                 <div class="maincapture"><?php echo ENTRY_PASSWORD; ?></td> <div class="maincapture"><?php echo ENTRY_PASSWORD_CONFIRMATION; ?></div>
       ...
       <div class="h2"><b><?php echo CATEGORY_COMPANY; ?></b><br></div>
     <div class="accountBox">
          <div class="accountBoxContents">
...
?>
       ...
       <div class="h2"><b><?php echo CATEGORY_ADDRESS; ?></b><br></div>
       <div class="accountBox">
          <div class="accountBoxContents">
           
                 <div class="maincapture"><?php echo ENTRY_STREET_ADDRESS; ?>  <div class="maincapture"><?php echo ENTRY_POST_CODE; ?></div>
...
?>
                 ...
                 <div class="maincapture"><?php echo ENTRY_CITY; ?>  <div class="maincapture"><?php echo ENTRY_COUNTRY; ?></div>
              ...
              <div class="maincapture"><?php echo tep_get_country_list('country') . '&nbsp;' . (tep_not_null(ENTRY_COUNTRY_TEXT) ? '<span class="inputRequirement">' . ENTRY_COUNTRY_TEXT . '</span>': ''); ?></div>
...
?>
       ...
       <div class="h2"><b><?php echo CATEGORY_OPTIONS; ?></b><br></div>
     <div class="accountBox">
          <div class="accountBoxContents">
           ...
           <div class="maincapture"><?php echo tep_draw_checkbox_field('newsletter', '1') . '&nbsp;' . (tep_not_null(ENTRY_NEWSLETTER_TEXT) ? '<span class="inputRequirement">' . ENTRY_NEWSLETTER_TEXT . '</span>': ''); ?></div>
              <div class="buttonBox"><?php echo tep_image_submit('button_continue.gif', IMAGE_BUTTON_CONTINUE); ?></div>
    </form>
<!-- body_text_eof //-->
