...
define('FOOTER_TEXT_BODY', 'Copyright &copy; ' . date('Y') . ' <a href="' . tep_href_link(FILENAME_DEFAULT) . '">' . STORE_NAME . '</a><br>Propuls� par <a href="http://www.ontc.eu" target="_blank">Francesco Rossi</a>');
?>
