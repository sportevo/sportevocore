...
<!-- body_text //-->
	...
	<td class="pageHeading" align="right" valign="top"><?php echo (($review['products_price'] > 0) ? $products_price : ''); ?></td>
...
<?php
  ...
  // Start "Hide Price if $0" edit 2 of 2 (uncomment above line if removing this contribution)
	...
	echo '<p><a href="' . tep_href_link(basename($PHP_SELF), tep_get_all_get_params(array('action')) . 'action=buy_now') . '">' . (($review['products_price'] > 0) ? tep_image_submit('button_in_cart.gif', IMAGE_BUTTON_IN_CART) : '') . '</a></p>'; 
