...
//end of code added by admin  showing the master for slave products
 $product_master_status_query = tep_db_query ("select products_master_status from " . TABLE_PRODUCTS . " where products_id =  '" . (int)$HTTP_GET_VARS['products_id'] . "'");
...
?>
    ...
    </table><?php echo tep_draw_hidden_field('products_id', $product_info['products_id']) . tep_image_submit('button_in_cart.gif', IMAGE_BUTTON_IN_CART); ?></form> <table width="794" border="0" align="center" cellpadding="0" cellspacing="0">
      <tr>
       <td><?php echo tep_draw_separator('pixel_trans.gif', '100%', '10'); ?></td>
      </tr>
      <tr>
